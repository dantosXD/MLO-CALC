...
await page.waitForTimeout(1500);
for (const role of ['textbox','button']) {
...
await page.getByRole('textbox').first().fill('payment for 400k at 6.5%');
await page.getByRole('button', { name: 'Process' }).click();
await page.waitForTimeout(3000);
await page.screenshot({ path: 'output/playwright/voice-text-processed.png', fullPage: true });
