...
await page.waitForTimeout(1500);
await page.getByRole('button', { name: 'Closing Costs\nEstimate fees & cash to close' }).click();
await page.waitForTimeout(3000);
await page.screenshot({ path: 'output/playwright/analysis-closing-costs.png', fullPage: true });
