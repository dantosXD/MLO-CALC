...
await page.getByRole('button', { name: 'PDF Report\nShare loan estimate' }).click();
await page.waitForTimeout(500);
await page.getByRole('button', { name: /^Calculator/ }).first().click();
await page.waitForTimeout(5000);
await page.screenshot({ path: 'output/playwright/analysis-after-navigation.png', fullPage: true });
