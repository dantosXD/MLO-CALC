...
await page.waitForTimeout(1500);
await page.getByRole('button', { name: 'ARM Wizard\nModel adjustable rate scenarios' }).click();
await page.waitForTimeout(1500);
await page.getByRole('button', { name: 'Generate schedule' }).click();
await page.waitForTimeout(4000);
await page.screenshot({ path: 'output/playwright/arm-wizard-schedule.png', fullPage: true });
