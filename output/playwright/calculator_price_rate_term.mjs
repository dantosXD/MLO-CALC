...
await page.getByRole('button', { name: 'Rate' }).first().click({ force: true });
await page.keyboard.type('7');
await page.getByRole('button', { name: 'Term' }).first().click({ force: true });
await page.keyboard.type('30');
await page.waitForTimeout(1000);
await page.screenshot({ path: 'output/playwright/calculator-price-rate-term.png', fullPage: true });
