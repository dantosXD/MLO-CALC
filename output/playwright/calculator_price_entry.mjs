...
for (const key of ['4','0','0','0','0','0']) {
  await page.getByRole('button', { name: key }).first().click({ force: true });
  await page.waitForTimeout(250);
}
await page.screenshot({ path: 'output/playwright/calculator-price-entry.png', fullPage: true });
