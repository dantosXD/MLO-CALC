...
class AmortizationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (calculatorProvider.amortizationData.isEmpty) {
      return SingleChildScrollView(
        child: Column(
          children: [
            _buildSummaryCard(context, calculatorProvider),
  ...
  Widget _buildSummaryCard(BuildContext context, CalculatorProvider calculatorProvider) {
    return Card(
      margin: const EdgeInsets.all(16),
      child: Padding(
