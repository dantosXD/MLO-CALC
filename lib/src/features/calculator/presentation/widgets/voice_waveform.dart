...
class VoiceWaveform extends StatelessWidget {
  ...
  const VoiceWaveform({super.key, required this.isListening, this.level = 0.0});
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: isListening
          ...
          : const Center(
              child: Icon(Icons.mic_none, size: 32, color: Colors.grey),
            ),
    );
  }
}
